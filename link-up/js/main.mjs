...
import { loadLocale, htmlLang } from "./i18n.mjs?v=35ad794d8cf9";
import * as storage from "./storage.mjs?v=35ad794d8cf9";
import * as audio from "./audio.mjs?v=35ad794d8cf9";
import { Game } from "./game.mjs?v=35ad794d8cf9";
import * as ui from "./ui.mjs?v=35ad794d8cf9";
import * as render from "./render.mjs?v=35ad794d8cf9";
