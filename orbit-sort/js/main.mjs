import { canExtract, canInsert } from "../engine.mjs?v=35ad794d8cf9";
import { createAudio } from "./audio.mjs?v=35ad794d8cf9";
import { createDailyLevel, todayKey } from "./daily.mjs?v=35ad794d8cf9";
import { CHAPTERS, LEVELS, levelById } from "../levels.mjs?v=35ad794d8cf9";
import { createGame } from "./game.mjs?v=35ad794d8cf9";
import { createBoardRenderer } from "./renderer.mjs?v=35ad794d8cf9";
import { isValidStoredState, loadProgress, recordCompletion, recordDailyCompletion, saveCurrentGame, saveSoundPreference } from "./storage.mjs?v=35ad794d8cf9";
import { computeScore, difficultyForLevel, baseScoreFor, moveScore, timeScore, moveMax, timeMax, perfectScoreForLevel } from "./score.mjs?v=35ad794d8cf9";
import { engineMessage, format, htmlLang, loadLocale, saveLocale, strings } from "./i18n.mjs?v=35ad794d8cf9";
...
const hintWorker = new Worker("./solver-worker.mjs?v=35ad794d8cf9", { type: "module" });
