import { canExtract, canInsert } from "../engine.mjs?v=48f76844757c";
import { createAudio } from "./audio.mjs?v=48f76844757c";
import { createDailyLevel, todayKey } from "./daily.mjs?v=48f76844757c";
import { CHAPTERS, LEVELS, levelById } from "../levels.mjs?v=48f76844757c";
import { createGame } from "./game.mjs?v=48f76844757c";
import { createBoardRenderer } from "./renderer.mjs?v=48f76844757c";
import { isValidStoredState, loadProgress, recordCompletion, recordDailyCompletion, saveCurrentGame, saveSoundPreference } from "./storage.mjs?v=48f76844757c";
import { computeScore, difficultyForLevel, baseScoreFor, moveScore, timeScore, moveMax, timeMax, perfectScoreForLevel } from "./score.mjs?v=48f76844757c";
import { engineMessage, format, htmlLang, loadLocale, saveLocale, strings } from "./i18n.mjs?v=48f76844757c";
...
const hintWorker = new Worker("./solver-worker.mjs?v=48f76844757c", { type: "module" });
