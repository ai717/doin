import { canExtract, canInsert } from "../engine.mjs?v=79c518024932";
import { createAudio } from "./audio.mjs?v=79c518024932";
import { createDailyLevel, todayKey } from "./daily.mjs?v=79c518024932";
import { CHAPTERS, LEVELS, levelById } from "../levels.mjs?v=79c518024932";
import { createGame } from "./game.mjs?v=79c518024932";
import { createBoardRenderer } from "./renderer.mjs?v=79c518024932";
import { isValidStoredState, loadProgress, recordCompletion, recordDailyCompletion, saveCurrentGame, saveSoundPreference } from "./storage.mjs?v=79c518024932";
import { computeScore, difficultyForLevel, baseScoreFor, moveScore, timeScore, moveMax, timeMax, perfectScoreForLevel } from "./score.mjs?v=79c518024932";
import { engineMessage, format, htmlLang, loadLocale, saveLocale, strings } from "./i18n.mjs?v=79c518024932";
...
const hintWorker = new Worker("./solver-worker.mjs?v=79c518024932", { type: "module" });
