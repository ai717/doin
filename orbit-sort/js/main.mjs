import { canExtract, canInsert } from "../engine.mjs?v=26665477a7d6";
import { createAudio } from "./audio.mjs?v=26665477a7d6";
import { createDailyLevel, todayKey } from "./daily.mjs?v=26665477a7d6";
import { CHAPTERS, LEVELS, levelById } from "../levels.mjs?v=26665477a7d6";
import { createGame } from "./game.mjs?v=26665477a7d6";
import { createBoardRenderer } from "./renderer.mjs?v=26665477a7d6";
import { isValidStoredState, loadProgress, recordCompletion, recordDailyCompletion, saveCurrentGame, saveSoundPreference } from "./storage.mjs?v=26665477a7d6";
import { computeScore, difficultyForLevel, baseScoreFor, moveScore, timeScore, moveMax, timeMax, perfectScoreForLevel } from "./score.mjs?v=26665477a7d6";
import { engineMessage, format, htmlLang, loadLocale, saveLocale, strings } from "./i18n.mjs?v=26665477a7d6";
...
const hintWorker = new Worker("./solver-worker.mjs?v=26665477a7d6", { type: "module" });
