...
const DICT = {
  ...
  en: {
    ...
    labelStars: "Stars",
    bossBadge: "BOSS!",
    wingLeftAria: "Garden Workshop plaque",
    wingRightAria: "Run Status plaque",
    deckAria: "Touch control deck",
    charGridAria: "Select a mower",
    modeChipsAria: "Pick a mode",
