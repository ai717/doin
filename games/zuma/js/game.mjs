...
import { addScore, resetScore, getScore, nextLevel, resetLevel, getLevel, getBestScore } from './score.mjs?v=dev';
import { playShootSound, playMatchSound, playDefeatSound, playVictorySound } from './audio.mjs?v=dev';
