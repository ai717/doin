...
| one-line | 连线网格 + 走线圆点 | 玫瑰粉 |
| klotski | 曹操滑块 + 纸兵陪衬 | 天蓝 |
| jigsaw | 凸起拼图碎片 + 漂浮彩点 | 亮青柠 |
| link-up | 锦鲤与祥云吉牌 + 金光 | 暖绯红 ⚠ 与 pair-link 接近 |
| pair-link | 琉璃瓦片 + 连线折角 | 绯红/金光 ⚠ 与 link-up 接近 |

> 蓝紫系（3张）、青绿系（2张）已饱和；玫瑰粉、天蓝、亮青柠、草绿、暖橙金均已占用。新封面优先选**未被占用**的色相：
> **橙红、明黄、靛蓝/深青、暖棕/古铜、绯红、紫红**。
