...
import { CloudGame } from "./game.mjs?v=35ad794d8cf9";
import { CloudRenderer } from "./render.mjs?v=35ad794d8cf9";
import { mountUI } from "./ui.mjs?v=35ad794d8cf9";
import { WORLD, MAX_LEVEL } from "./engine.mjs?v=35ad794d8cf9";
import {
  loadLocale,
  saveLocale,
  strings,
  htmlLang,
  format,
} from "./i18n.mjs?v=35ad794d8cf9";
import {
  load as loadStorage,
  recordResult,
  setSound as saveSound,
} from "./storage.mjs?v=35ad794d8cf9";
