...
import { advanceFrame, createGame, dispatch, snapshot } from "./game.mjs?v=35ad794d8cf9";
...
import { format, htmlLang, loadLocale, saveLocale, strings } from "./i18n.mjs?v=35ad794d8cf9";
