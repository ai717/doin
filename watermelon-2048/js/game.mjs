...
import { applyIntent, createState, stepFrame } from "./engine.mjs?v=79c518024932";
...
export function snapshot(game) {
  const { score, maxLevel, maxChain, mode, harvested, first2048At } = game.state;
  return { score, maxLevel, maxChain, mode, harvested, time: first2048At === null ? 0 : first2048At };
}
