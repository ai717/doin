...
import {
    ...
    DIFFICULTY_CONFIG,
    BALL_RADIUS
} from './engine.mjs?v=26665477a7d6';
...
import {
    ...
    hidePauseScreen,
    updateScoreUI
} from './ui.mjs?v=26665477a7d6';

import { addScore, resetScore, getScore, nextLevel, resetLevel, getLevel, getBestScore } from './score.mjs?v=26665477a7d6';
import { playShootSound, playMatchSound, playDefeatSound, playVictorySound } from './audio.mjs?v=26665477a7d6';
