...
import {
    ...
    hidePauseScreen,
    updateScoreUI
} from './ui.mjs?v=35ad794d8cf9';

import { addScore, resetScore, getScore, nextLevel, resetLevel, getLevel, getBestScore } from './score.mjs?v=35ad794d8cf9';
import { playShootSound, playMatchSound, playDefeatSound, playVictorySound } from './audio.mjs?v=35ad794d8cf9';
