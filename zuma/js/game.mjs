...
import {
    ...
    hidePauseScreen,
    updateScoreUI
} from './ui.mjs?v=79c518024932';

import { addScore, resetScore, getScore, nextLevel, resetLevel, getLevel, getBestScore } from './score.mjs?v=79c518024932';
import { playShootSound, playMatchSound, playDefeatSound, playVictorySound } from './audio.mjs?v=79c518024932';
